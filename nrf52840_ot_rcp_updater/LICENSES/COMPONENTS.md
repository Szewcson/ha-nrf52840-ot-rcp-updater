...
- `/usr/share/licenses/pca10059-openthread-rcp-updater/alpine-packages.tsv`
  is the installed Alpine package and version inventory captured at image
  build time.
