...
class AppArmorProfileTests(unittest.TestCase):
    ...
    def test_nrfdfu_uses_a_local_helper_profile(self) -> None:
        ...
        self.assertIn("/usr/bin/python3.14 cx -> nrf52840_ot_rcp_updater_python,", profile)
        self.assertIn("/usr/bin/python3.14 mr,", profile)
        self.assertNotIn("python3.11", profile)
